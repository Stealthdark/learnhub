/* ═══════════════════════════════════════════════════════
   ...
   Email is now sent via Nodemailer on the backend server.
   SMTP credentials live in server/.env — not configurable
   from the UI. To change email settings, update the
   SMTP_HOST / SMTP_PASS variables in your server environment
  ...
  return(
    <div className="page-pad" style={{maxWidth:700}}>
      ...
      <div className="card" style={{padding:28}}>
        ...
        <div style={{fontSize:13,fontWeight:600,color:"var(--text2)",marginBottom:12,textTransform:"uppercase",letterSpacing:".06em",fontSize:11}}>
