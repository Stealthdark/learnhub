export default function AvatarEl({ user, size = 32 }) {
  ...
  return (
    <div style={{ width: size, height: size, borderRadius: '50%', background: bg, display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff', fontSize: Math.max(10, size * 0.38), fontWeight: 700, flexShrink: 0 }}>
      {initials}
    </div>
  )
}
